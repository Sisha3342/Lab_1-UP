...
// ROFLAN_MFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CROFLANMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CROFLANMFCApp

CROFLANMFCApp::CROFLANMFCApp()
{
...
// Единственный объект CROFLANMFCApp

CROFLANMFCApp theApp;


// Инициализация CROFLANMFCApp

BOOL CROFLANMFCApp::InitInstance()
{
